        ...
        <div class="content">
            ...
            <a class="ticket-action" id="ticket-transfer" data-placement="bottom" data-toggle="tooltip"
               ...
               href="#tickets/<?php echo $ticket->getId(); ?>/transfer"><i class="icon-share"></i></a>
                ...
                ?>
                <a href="./scp/ajax.php/tickets/67/status" class="quickCloseTicket action-button" data-placement="bottom" data-toggle="tooltip"
                   title="Close Ticket"><i class="glyphicon glyphicon-folder-close"></i></a>
                <?php if ($thisstaff->isAdmin()) { ?>
                    <a class="quickBombTicket action-button" data-placement="bottom" data-toggle="tooltip"
                       title="Bomb Ticket"><i class="glyphicon glyphicon-fire"></i></a>
                <?php } ?>
            </div>
