        ...
        <div class="content">
            <div class="pull-right flush-right">
				...
				if ($role->hasPerm(TicketModel::PERM_EDIT)) { ?>
                    <span class="action-button pull-right"><a data-placement="bottom" data-toggle="tooltip"
                                                              title="<?php echo __('Edit'); ?>"
                                                              href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=edit"><i
            ...
            <a class="ticket-action" id="ticket-transfer" data-placement="bottom" data-toggle="tooltip"
               title="<?php echo __('Transfer'); ?>"
               ...
               href="#tickets/<?php echo $ticket->getId(); ?>/transfer"><i class="icon-share"></i></a>
                ...
                <div class="hidden">
                    ...
                    <input type="hidden" value="<?= trim($ticket->getProfileId()); ?>" name="Ticket[ProfileId]"
                           id="TicketProfileId">
                    ...
                    <form action="" target="_blank" method="post" id="billSupportForm">
                        ...
                        <input type="hidden" value="<?= $ticket->getLastMessageDate(); ?>"
                               name="Prefill[data][0][date]">
                        <input type="hidden" value="<?= $staffUsername; ?>" name="Prefill[data][0][doneby]">

                        <input type="submit" class="hidden" id="submitBillSupportFom">
                    </form>
                </div>

                <span class="billSupportButton action-button" data-placement="bottom" data-toggle="tooltip"
                      title="Bill support"><i class="glyphicon glyphicon-eur"></i></span>

            </div>
            <div class="flush-left">
                <h2><a href="tickets.php?id=<?php echo $ticket->getId(); ?>"
                       title="<?php echo __('Reload'); ?>"><i class="icon-refresh"></i>
						<?php echo sprintf(__('Ticket #%s'), $ticket->getNumber()); ?></a><a><?php echo trim($ticket->getProfileId());?></a>
                </h2>
            </div>
        </div>
    </div>
...
<!-- Side popup -->
<div id="sticky-side">
    <div class='gotop-btn' style='top:95px !important;' onclick="$('html, body').animate({scrollTop:0}, '300');">to
        top
    </div>
    <div class='gotop-btn' style='top:303px !important; right:140px; width:130px;'
         onclick="$('html, body').animate({scrollTop: $('.thread-entry').not('.system').last().offset().top - 50 }, '300');">
        TO LAST MSG
    </div>
                            ...
                            <div id="action-dropdown-stats" class="action-dropdown anchor-right">
                                <ul>
                                    ...
                                    <li><a href="tickets.php?a=search&uid=<?php echo $ticket->getOwnerId(); ?>"><i
                                                    class="icon-double-angle-right icon-fixed-width"></i> <?php echo __('All Tickets'); ?>
                                        </a></li>
                                ...
                                <ul>
									...
									if ($closed = $user->getNumClosedOrganizationTickets()) { ?>
                                        ...
                                        <li><a href="tickets.php?<?php echo Http::build_query(array(
											...
											)); ?>"><i class="icon-double-angle-right icon-fixed-width"></i> <?php echo __('All Tickets'); ?>
                                            </a></li>
									<?php }
        ...
        >
                ...
                <form id="reply" class="tab_content spellcheck exclusive save"
                    ...
                    <table style="width:100%" border="0" cellspacing="0" cellpadding="3">
						...
						if ($errors['reply']) { ?>
                            <tr>
                                <td width="120">&nbsp;</td>
                                <td class="error"><?php echo $errors['reply']; ?>&nbsp;</td>
                            </tr>
							<?php
						} ?>
                        <tbody id="to_sec">
                        <tr>
                            ...
                            <td>
                                ...
                                <select id="emailreply" name="emailreply">
                                    ...
                                    >&mdash; <?php echo __('Do Not Email Reply'); ?> &mdash;
                                    </option>
                                </select>
                            </td>
                        </tr>
						...
						if (1) { //Make CC optional feature? NO, for now.
                            ...
                            <tr>
                                ...
                                <td>
									...
									echo sprintf(
										'<span><a class="collaborators preview"
                            ...
                            <td>
								<?php if ($cfg->isCannedResponseEnabled()) { ?>
                                    <select id="cannedResp" name="cannedResp">
                                        <option value="0"
                                                selected="selected"><?php echo __('Select a canned response'); ?></option>
                        ...
                        <tr style="display: none">
                            ...
                            <td>
								...
								?>
                                <label><input type="radio" name="signature" value="none"
                                              checked="checked"> <?php echo __('None'); ?></label>
								<?php
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select name="reply_status_id" class='status'>
									<?php
            ...
            <form id="note" class="hidden tab_content spellcheck exclusive save"
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr>
                        <td width="120" style="vertical-align:top">
                            <label><strong><?php echo __('Internal Note'); ?>:</strong><span
        ...
        <fieldset class="notes">
            ...
            <label class="inline checkbox">
                <input type="checkbox" id="notes" name="notes"
                       value="1"> <?php echo __('Print <b>Internal</b> Notes/Comments'); ?>
            </label>
        </fieldset>
        <fieldset>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="changeuser-confirm">
        ...
        <?php echo sprintf(
			Format::htmlchars(__('%s <%s> will longer have access to the ticket')),
