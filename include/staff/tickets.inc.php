		...
		foreach ($tickets as $T) {
            ...
            <tr id="<?php echo $T['ticket_id']; ?>" class="<?= $statusClass ?>">
				...
				<?php if (isset($queue_columns['cdata__profile_id'])) {
					...
					?>
                    <td nowrap><span class="" style="max-width: 150px">
                       <?php
                       ...
                       } else echo "<a class='assignToprofile' href='#tickets/[$T['ticket_id'];}/assign/profile'
                               data-redirect='tickets.php?status=open'><?php echo __('Assign'); ?></a>";
