...
class TicketModel extends VerySimpleModel
{
    ...
    static protected $perms = array(
        self::PERM_CREATE => array(
            ...
            'desc' =>
            /* @trans */
                'Ability to open tickets on behalf of users'),
        ...
        self::PERM_ASSIGN => array(
            ...
            'desc' =>
            /* @trans */
                'Ability to assign tickets to agents or teams'),
        ...
        self::PERM_REPLY => array(
            ...
            'desc' =>
            /* @trans */
                'Ability to post a ticket reply'),
...
RolePermission::register(/* @trans */
    'Tickets', TicketModel::getPermissions(), true);
